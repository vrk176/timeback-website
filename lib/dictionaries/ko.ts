...
const ko: Dictionary = {
  meta: {
    ...
    description:
      "TimeBack은 강력한 개인정보 보호 우선 도구로 더 건강한 화면 습관을 만들도록 도와줍니다. 일일 제한, 강제 휴식, 일정, 위치 구역 등. 무료이며 100% 비공개입니다.",
  },
  hero: {
    badge: "App Store에 곧 출시",
    titleLine1: "시간을,",
    titleLine2: "나에게 돌려주세요.",
    subtitle:
      "강력한 개인정보 보호 우선 도구로 더 건강한 화면 습관을 만드세요. 무료. 계정 불필요. 광고 없음.",
  ...
  features: {
    eyebrow: "기능",
    titlePart1: "집중을 유지하는 데 필요한",
    titleHighlight: "모든 것",
    subtitle:
      "백그라운드에서 조용히 작동하는 강력한 도구가 방해하지 않으면서 더 나은 화면 습관을 만들도록 도와줍니다.",
    items: [
      {
        title: "일일 제한",
        description:
          "모든 앱이나 카테고리에 사용 시간 제한을 설정하세요. 시간이 다 되면 자동으로 차단됩니다 — 의지력이 필요 없습니다.",
      },
      {
        title: "휴식 모드",
        description:
          "지속적인 사용 후 강제 휴식으로 집중력과 눈을 보호합니다. 준비가 되면 자동으로 재개됩니다.",
      },
      {
        title: "일정",
        description:
          "업무, 공부, 수면 시간대에 방해가 되는 앱을 차단합니다. 자정을 넘는 일정도 지원합니다.",
      },
      {
        title: "위치 구역",
        description:
          "학교나 사무실과 같은 특정 구역에 들어가면 자동으로 앱을 차단합니다.",
      },
      {
        title: "맞춤 차단 화면",
        description:
          "자신만의 아이콘, 메시지, 잠금 해제 방법으로 차단 화면을 개인화하세요.",
      },
      {
        title: "보호자 모드",
        description:
          "부모나 책임 파트너가 보관하는 별도의 암호. 규칙이 우회되는 것을 방지합니다.",
      },
    ],
  },
  showcase: {
    ...
    subtitle:
      "방해하지 않으면서 당신이 집중할 수 있도록 디자인된 아름답고 직관적인 인터페이스.",
    labels: [
      "환영합니다",
      "일일 제한",
      "일정",
    ...
    steps: [
      {
        title: "규칙 설정",
        description:
          "제한할 앱을 선택하고 일일 제한, 일정, 위치 기반 차단을 구성하세요. 1분도 걸리지 않습니다.",
      },
      {
        title: "집중 유지",
        description:
          "TimeBack은 백그라운드에서 조용히 작동합니다. 제한에 도달하면 맞춤형 차단 화면이 나타나 휴식을 취하도록 부드럽게 안내합니다.",
      },
      {
        title: "더 나은 습관 만들기",
        description:
          "시간이 지나면서 자연스럽게 휴대폰을 덜 찾게 됩니다. TimeBack은 정말 중요한 것에 시간을 되찾는 데 도움을 줍니다.",
      },
    ],
  },
  privacy: {
    ...
    items: [
      {
        title: "기기에만 저장",
        description:
          "모든 데이터는 iPhone에 저장됩니다. 아무것도 기기를 떠나지 않습니다.",
      },
      {
        title: "계정 불필요",
        description:
      ...
      },
      {
        title: "추적 없음",
        description:
          "분석 없음, 원격 측정 없음, 데이터 수집 없음. 우리는 당신의 데이터를 볼 수 없습니다.",
      },
      {
        title: "Apple 공식 API",
        description:
          "Apple의 Screen Time API로 구축. 안전하고, 샌드박스화되며, 신뢰할 수 있습니다.",
      },
    ],
  },
  cta: {
    title: "곧 출시",
    subtitle:
      "TimeBack이 App Store에 곧 출시됩니다 — 완전히 무료입니다. 기대해 주세요.",
    badge: "곧 App Store에서 만나보세요",
  },
  footer: {
    features: "기능",
    privacy: "개인정보 처리방침",
